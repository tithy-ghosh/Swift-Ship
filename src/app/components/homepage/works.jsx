...
const Works = () => {
  return (
    <section className="flex flex-col gap-8 pb-8 sm:gap-10 sm:pb-12 lg:pb-16">
      <div
        className="mx-auto flex max-w-2xl flex-col items-center justify-center pt-4 text-center"
        data-aos="fade-up"
      >
      ...
      <div className="grid grid-cols-1 gap-4 pt-2 min-[520px]:grid-cols-2 lg:grid-cols-4 lg:gap-5">
